...
API_TOKEN = '7772996897:AAGLo9XbNa48XE9j01x6ifTYpwJGBSLtlrM'
ADMIN_CHAT_ID = '6686272246'  # Replace with the actual admin ChatID
bot = telebot.TeleBot(API_TOKEN)

# Database paths
DB_PATH = 'wuzzstore.db'
BACKUP_DIR = 'backups'
